                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div
                            ...
                            <div className="ps-block__content">
                                ...
                                <ul>
                                    <li>
                                        <Link href={'/shop'}>Funitures</Link>
                                    </li>
                                    <li>
                                        <Link href={'/shop'}>Decor</Link>
                                    </li>
                                    <li>
                                        <Link href={'/shop'}>Cookwares</Link>
                                    </li>
                                    <li>
                                        <Link href={'/shop'}>
                                            Utensil & Gadgets
                                    ...
                                    <li>
                                        <Link href={'/shop'}>Garden Tools</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                        <div
                            ...
                            <div className="ps-block__content">
                                ...
                                <ul>
                                    <li>
                                        <Link href={'/shop'}>Pendant</Link>
                                    </li>
                                    <li>
                                        <Link href={'/shop'}>Necklace</Link>
                                    </li>
                                    <li>
